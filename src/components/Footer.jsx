...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#240b36] to-[#930a21] w-full mt-10">
  <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex items-center  justify-center  gap-3 text-teal-300  ">
         <img src={Logo} className='object-cover w-[4rem] object-center' alt="" />
         <p>Rapid Compiler</p> 
        </div>
        <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 py-5 md:w-full ">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt
          consequuntur amet culpa cum itaque neque.
        </p>
        <ul className="flex justify-center gap-6 mt-8   py-5  md:items-center">
          <li>
            <a
              href="/"
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4   md:content-center ">
